    ...
    <div class="row mb-3">
      <div class="col-md-4 mb-3">
        <div class="bg-white rounded shadow p-3 text-center">
          <span class="h2 text-center d-block">المراكز</span>
          <span class="text-danger display-1 text-center d-block">{{ data.center }}</span>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="bg-white rounded shadow p-3 text-center">
          <span class="h2 text-center d-block">الإبلاغات</span>
          <span class="text-danger display-1 text-center d-block">{{ data.reports }}</span>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="bg-white rounded shadow p-3 text-center">
          <span class="h2 text-center d-block">إبلاغات تم التكفل بها</span>
          <span class="text-danger display-1 text-center d-block">{{ data.solved }}</span>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12 mb-3">
        <span class="h1">إحصائيات تقدم المنصة:</span>
      </div>
      <div class="col-12 mb-3">
...
export default {
  ...
  methods: {
    getData(){
      axios.get('/admin/home').then(response=>{
